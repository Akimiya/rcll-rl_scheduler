...
\subsection{Robo Cup Idea}
The Robo Cup Logistics League (RCLL) is designed to represent a common scenario in Industry $4.0$. The challenge consists in assembling products based on dynamic custom orders in a real-time environment. This leads us to a consistent stream of orders and individual delivery windows. .....
